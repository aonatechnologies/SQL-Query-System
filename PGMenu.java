...
public class PGMenu extends Frame implements WindowListener,ActionListener{
	...
	public PGMenu(Frame topmenu){
		...
		Label argNumLabel = new Label("Number of test case arguments:");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() instanceof Button){
	    	...
	    	if(((Button)e.getSource()).getLabel().equals("Submit Case")||((Button)e.getSource()).getLabel().equals("Continue")){
	    		((Button)e.getSource()).getParent().setVisible(false);
	    	...
	    	if(((Button)e.getSource()).getLabel().equals("Add Test Case")){
	    		if(!numOfArgs.getText().matches("^-?\\d+$")){
	    			Dialog e2 = new Dialog(this,"Error");
		    		e2.setLayout(new BoxLayout(e2,BoxLayout.Y_AXIS));
		    		e2.add(new Label("Please enter amount of test cases."));
		    		e2.setVisible(true);
